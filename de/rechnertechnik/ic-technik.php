<?php
	...
	$version = '$Id$';
	$titel = 'Programmierbare Rechner der 3. Generation mit einfacher IC-Technik';
...
Mit dem angeschlossenen Markierungskartenleser (anstelle ausgestanzter Löcher werden Felder per Hand geschwärzt) war der Rechner auch für Schulen und Universitäten ideal nutzbar. Offline konnten beliebig viele Anwender Programme auf Karten markieren und dann mit einem einzigen Rechner testen.<br>
    ...
    <h3 id="diehl">Diehl Combitronic</h3>
	   ...
	   Für umfangreiche wissenschaftliche Berechnungen und komplexere Programme führte jedoch kein Weg an WANG bzw. HP vorbei.
		...
		<p>Entwicklungsgeschichte der HP-Tischrechner in einem Regal:</p>
            ...
            <ul>
              ...
              <li>Oben befindet sich der bekannteste HP-Rechner: HP 9830, Bj. 1972 mit Lochstreifenleser, Lochstreifenstanzer und Plotter. Dies ist der erste BASIC-programmierbare Tischrechner der Welt.</li>
			</ul>
        </div>
    </div>
